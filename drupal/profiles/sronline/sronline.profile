 ...
 */
function sronline_import_users() {
  global $db_url;
 ...
 */
function sronline_import_texts() {
  global $db_url;
  if (empty($db_url['legacy'])) {
    return;
  }
...
function sronline_import_terms() {
  global $db_url;
  if (empty($db_url['legacy'])) {
    return;
  }
...
function sronline_import_discussions() {
  global $db_url;
  if (empty($db_url['legacy'])) {
    return;
  }
...
function sronline_import_comments($type) {
  global $db_url;
  if (empty($db_url['legacy'])) {
    return;
  }
